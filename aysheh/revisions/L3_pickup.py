...
v1_min = 130    # min H value day(145) night (130)
v2_min = 95    # min S value day(100) night (95)
v3_min = 85     # min V value day(85) night (85)

v1_max = 180    # max H value day(220) night (180)
v2_max = 185    # max S value day(220) night (185)
v3_max = 185    # max V value day(255) night (185)
...
def main():
    ...
    tf = 30      # Too Far       - Minimum pixel size of object to track
    tp = 9     # Target Pixels - Target size of object to track
        ...
        while rcpy.get_state() != rcpy.EXITING:
            if rcpy.get_state() == rcpy.RUNNING:
                ...
                if len(cnts) > 0:   # If more than 0 closed shapes exist
                    ...
                    print("x: ", x, "\ty: ", y, "\tR: ", radius, "\tcircle:", c)
                    ...
                    if x > ((width/2)-(band/2)) and x < ((width/2)+(band/2)):       # If center point is centered
                        ...
                        elif radius < tc: # Too far
                            case = "too far"
                            duty = 1 - ((radius - tf)/(tp - tf))
                            duty = scale_d * duty
                            print("apprach item(s)")
                        duty_r = duty
                        duty_l = duty
